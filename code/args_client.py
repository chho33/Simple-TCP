...
parser.add_argument('file_path', default="hello.txt", type=str)
parser.add_argument('server_address', default="localhost", type=str)
parser.add_argument('server_port', default=41194, type=int)
parser.add_argument('window_size', default=100, type=int, help="integer window size (bytes)")
